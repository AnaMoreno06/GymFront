                            ...
                            <Form onSubmit={handleRegistrarMembresia}>
                              {usuarioMembresia && existeUsuario ? (
                                <>
                                  ...
                                  <Table responsive className="striped">
                                    <thead>
                                      <tr>
                                      <th>Activa</th>
                                      ...
                                      {usuarioMembresia.usuarioMembresias.map(
                                        (membresia) => (
                                          <tr key={membresia.id}>
                                            ...
                                            <td><i className="fa fa-check-circle text-success" /></td>
                                            <td>
                                              {
                                ...
                                {membresias ? (
                                  <>
                                    {membresias.map((membresia) => (
                                      <Col lg="6" xl="3" key={membresia.id}>
                                        <Card
                                            ...
                                            <Row>
                                              ...
                                              <div className="col">
                                                ...
                                                <p className="h2 font-weight-bold mb-0 text-center">
                                                  {membresia.precio.toLocaleString('es-CO', { style: 'currency', currency: 'COP' })}
                                                </p>
                                              </div>
                                            </Row>
                                            <br />
                              ...
                              <div>
                                <p className="text-success text-center h1">Membresia Registrada</p>
                              </div>
                              )}
                            </Form>
                          </Col>
        ...
        <div className="modal-body p-0">
          <Card className="bg-secondary shadow border-0">
            <CardHeader className="bg-transparent pb-0 d-flex justify-content-between">
              ...
              <button className="btn btn-close text-dark"
                style={{
