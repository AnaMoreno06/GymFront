        ...
        <Row className="align-items-center justify-content-xl-between">
          ...
          <Col xl="12">
            <Nav className="nav-footer justify-content-center justify-content-xl-center h1 ">
              <NavItem>
                <NavLink href="/training" className="text-white">Entrenamiento</NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="/training" className="text-white">Membresias</NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="/contact" className="text-white">Contacto</NavLink>
              </NavItem>
            </Nav>
          </Col>
        </Row>
